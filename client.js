// `source/router/client/createRouterElement.js`
//   `import` `found-scroll`
...
//
// So exporting `./source/redux/client/setUpAndRender` in the main file
...
//
export { default as render } from './source/redux/client/setUpAndRender.js'
export { default as createStore } from './source/redux/client/createStore.js'