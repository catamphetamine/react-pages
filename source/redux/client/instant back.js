...
export function add_instant_back(next_location, previous_location)
{
	...
	if (instant_back)
	{
		...
		{
			console.error('[react-website] Error: previous location not found in an already existing instant back navigation chain', get_location_key(previous_location), instant_back)
