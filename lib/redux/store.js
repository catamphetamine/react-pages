...
import preloadReducer from './load/reducer.js'
import createGetDataForPreload from './load/getData.js'
...
export default function _createStore(settings, data, createHistoryProtocol, httpClient, options)
{
	...
	// Add `load` data hook.
	const getData = createGetDataForPreload({
		codeSplit,
		server,
		onError,
		getLocale,
		getConvertedRoutes,
		getCookie,
		getContext: load && load.getContext
	})
