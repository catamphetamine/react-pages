const debug = (...args) => {
	if (window._ReactPages_InstantNavigationDebug) {
		console.log(...args)
	}
}
...
function getInstantNavigationChain() {
	if (window._ReactPages_InstantNavigationChain === undefined) {
		window._ReactPages_InstantNavigationChain = []
	}
	return window._ReactPages_InstantNavigationChain
}

function getInstantNavigationChainIndex() {
	if (window._ReactPages_InstantNavigationChainIndex === undefined) {
		window._ReactPages_InstantNavigationChainIndex = -1
	}
	return window._ReactPages_InstantNavigationChainIndex
}

function setInstantNavigationChain(value) {
	window._ReactPages_InstantNavigationChain = value
}

function setInstantNavigationChainIndex(value) {
	window._ReactPages_InstantNavigationChainIndex = value
}
...
export function isInstantBackNavigation() {
	return window._ReactPages_Page_IsInstantBackNavigation
}
