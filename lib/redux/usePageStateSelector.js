import useSelectorForLocation from './useSelectorForLocation.js'
...
export default function usePageStateSelector(reducerName, selectorFromReducerState) {
	...
	return usePageStateSelectorWithCustomUseSelector(reducerName, selectorFromReducerState, useSelectorForLocation)
}
