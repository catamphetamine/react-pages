...
export default function RouterContextValueProvider({
	...
	useCurrentRouteChangeEffect({
		...
		currentRouteInstantBack: currentRouteInstantBackValue,
		currentRouteNavigationContext: currentRouteNavigationContextValue
	})
...
function onRouteChange(route, {
	...
	const beforeRenderNewPageListeners = takeFromContext('Root/BeforeRenderNewPage')
